...
const Section10: React.FC = () => {
  ...
  return (
    <section className="relative -mt-1 h-full w-full flex flex-col sm:flex-row justify-between items-start pb-10 sm:pb-20 pt-16 bg-[#111C46] text-white ">
      ...
      <div className="absolute sm:h-1/2 z-10 sm:left-1/2 left-75 rotate-25 sm:rotate-0 top-7 sm:top-[52%] transform -translate-x-1/2 flex sm:flex-col space-y-2">
        <img src={star} alt="Imagen 1" className="w-8 ml-2 sm:ml-0 sm:w-16 sm:w-27 animate-fade" />
        <img src={star} alt="Imagen 2" className="w-8 ml-5 sm:ml-0 sm:w-16 sm:w-27 animate-fade" />
        <img src={star} alt="Imagen 3" className="w-8 ml-5 sm:ml-0 sm:w-16 sm:w-27 animate-fade" />
      </div>
