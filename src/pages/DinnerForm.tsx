...
const DinnerForm = () => {
  ...
  return (
    <div
      className="min-h-screen pt-5 pb-5 bg-cover bg-center flex items-center justify-center px-4"
      style={{ backgroundImage: `url(${backgroundImage})` }}
    >
      <LanguageSelector />
      <form
        onSubmit={handleSubmit}
        className="bg-white/20 backdrop-blur-xs p-8 rounded-2xl max-w-2xl w-full text-white space-y-6 shadow-xl"
      >
        {/* Título con imagen */}
        <div className="text-center flex justify-center align-center w-full">
          <img src={getSvgLogoByLanguage()} alt="Una Cena por una Sonrisa" className="sm:w-40 h-auto self-center" />
        </div>
        ...
        <div>
          ...
          <div className="flex flex-row justify-center  mt-4 gap-2 text-sm">
